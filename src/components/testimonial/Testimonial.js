        ...
        <Slider {...settings}>
          <div className="w-full">
            <div className="w-full h-[500px] flex justify-between">
              <div
                div
                className="w-[35%] h-full bg-gradient-to-r from[#1e2024] to-[#2327b] p-8 rounded-lg shadow-shadowOne
              ...
              <div className="w-[60%] h-full flex flex-col justify-between">
                ...
                <div
                  className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-8
