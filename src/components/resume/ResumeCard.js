...
const ResumeCard = ({title, subTitle, result,des, description}) => {
  return (
    ...
    <div className="w-10 h-[6px] bgOpacity mt-16 relative">
     ...
     <div 
        className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg p-4 lgl:px-10 
        flex flex-col justify-center gap:6 lgl:gap-10 shadow-shadowOne">
